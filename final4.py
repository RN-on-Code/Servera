...
def process_yeah_response(api_key, onroad_messages, from_location, to_location):
    ...
    if onroad_addresses:
        # Calculate distance between the byroad "from" location and each onroad location
        distances = [calculate_distance(api_key, from_location, onroad_address) for onroad_address in onroad_addresses]
