...
def process_byroad_message(api_key, price_per_km, byroad_message):
    from_location, to_location = extract_locations(byroad_message)
    if from_location and to_location:
        ...
        if distance_text:
            ...
            calculate_eta(from_location, to_location, api_key)
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        while True:
            ...
            if new_byroad and new_byroad != most_recent_byroad:
                ...
                # Submit the processing of the byroad message to the ProcessPoolExecutor
                executor.submit(process_byroad_message(api_key, price_per_km, new_byroad), api_key, price_per_km, new_byroad)
